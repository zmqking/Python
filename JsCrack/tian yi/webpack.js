...
(function(e) {
            ...
            return c = Object(r["a"])(regeneratorRuntime.mark((function e(n) {
                ...
                return regeneratorRuntime.wrap((function(e) {
                    while (1)
                        ...
                        case 0:
                            return t = "alogic-ctcloudet/v1/portal/pv/Info",
                            e.abrupt("return", a["a"].post(t, {
                                data: n
                            }));
                        case 2:
                        case "end":
                ...
                return regeneratorRuntime.wrap((function(n) {
                    while (1)
                        ...
                        case 9:
                            n.t6 = n.sent,
                            n.t7 = S(),
                            n.t8 = window.__ctPerformance ? window.__ctPerformance.traceid : "",
                            n.t9 = Date.now(),
                            t = {
                                sid: n.t0,
                                pvid: n.t1,
    ...
    "32ee": function(e, n, t) {
        ...
        function T() {
            return T = Object(a["a"])(regeneratorRuntime.mark((function e() {
                var n;
                return regeneratorRuntime.wrap((function(e) {
                    while (1)
                        switch (e.prev = e.next) {
        ...
        function xe(e) {
            var n = "/alogic-ctyun/account/cash/UploadBankVoucher";
            return o["a"].post(n, e, {
                headers: {
                    "Content-Type": "multipart/form-data"
                }
    ...
    3779: function(e, n, t) {
        ...
        function M() {
            var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
            E.push(e),
            j.canIUse("PerformanceObserver") || (j.canIUse("performance.getEntries") ? q(performance.getEntries()) : j.throttle(T, this, 1500))
        }
        function _() {
            var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}
            ...
            actions: {
                queryAccountInfo: function(e) {
                    ...
                    Object(f["E"])().then((function(e) {
                        ...
                        Promise.all([Object(h["c"])(), Promise.resolve(e.data)])
                    }
                    )).then((function(e) {
    ...
    7306: function(e, n, t) {
        ...
        function E() {
            return E = Object(r["a"])(regeneratorRuntime.mark((function e(n) {
                var t;
                return regeneratorRuntime.wrap((function(e) {
                    while (1)
                        switch (e.prev = e.next) {
        ...
        function ae() {
            return ae = Object(r["a"])(regeneratorRuntime.mark((function e() {
                var n;
                return regeneratorRuntime.wrap((function(e) {
                    while (1)
                        switch (e.prev = e.next) {
    ...
    b196: function(e, n, t) {
        ...
        var A = t("ed09")
          ...
          , E = L
          , T = (t("8d96"),
        Object(p["a"])(E, j, B, !1, null, null, null))
          , M = T.exports
          , _ = (t("3b2b"),
        t("5df3"),
        t("1c4c"),
        ...
        t("cdf3"))
                ...
                return regeneratorRuntime.wrap((function(e) {
                    while (1)
                        ...
                        case 3:
                            ...
                            oe["a"].get(n, {
                                params: {
                                    domain: "console.menu.check"
                                }
                            });
                        case 5:
                            return t = e.sent,
                            ce(n, JSON.stringify(t)),
                            e.abrupt("return", t);
                        case 10:
                            return e.prev = 10,
                            e.t0 = e["catch"](0),
          ...
          , ue = function() {
            var e = Object(c["a"])(regeneratorRuntime.mark((function e(n) {
                var t, r, a, o, c = arguments;
                return regeneratorRuntime.wrap((function(e) {
                    while (1)
                        switch (e.prev = e.next) {
                        case 0:
                            if (t = c.length > 1 && void 0 !== c[1] && c[1],
        ...
        Object(c["a"])(regeneratorRuntime.mark((function e() {
            ...
            return regeneratorRuntime.wrap((function(e) {
                while (1)
                    ...
                    case 0:
                        return e.prev = 0,
                        n = "alogic-ctcloudet/v1/portal/menu/GetTree",
                        e.next = 4,
                        ue(n, !0, !0);
                    case 4:
                        if (t = e.sent,
                    ...
                    case 8:
                        a = function() {
                            r.forEach((function(e) {
                                ...
                                if (location.href.indexOf(t) >= 0) {
                                    if (r && RegExp(r).test(location.href))
                                        return !1;
                        ...
                        ,
                        window.history.pushState = c("pushState"),
                        window.history.replaceState = c("replaceState"),
                        window.addEventListener("pushState", o, !0),
                        window.addEventListener("replaceState", o, !0),
                        window.addEventListener("popstate", o, !0),
                        window.addEventListener("beforeunload", (function() {
                            window.removeEventListener("pushState", o, !0),
                            window.removeEventListener("replaceState", o, !0),
                            window.removeEventListener("popstate", o, !0)
                        }
                        )),
                        a(),
                        e.next = 24;
        ...
        i["a"].on(i["a"].events.AUTH_FAIL, (function() {
            S["a"].dispatch("auth/logout"),
            de(m["a"].currentRoute.query.redirect || m["a"].currentRoute.fullPath)
        }
        ));
        var se = t("6bf2").default;
        if (m["a"].beforeEach((function(e, n, t) {
            Object(d["h"])().then((function() {
                se.isLogin() || S["a"].dispatch("account/queryAccountInfo"),
                se.updateLoginStatus(!0),
                ...
                S["a"].dispatch("auth/logout")) : console.log(n)
            }
            ))
        }
        )),
        ...
        window.CtcloudAnalysis) {
            var le = window.location.href
              , pe = "";
            pe = le.includes("m.ctyun.cn") ? "https://m.ctyun.cn" : le.includes("mgray.ctyun.cn") ? "https://mgray.ctyun.cn" : "https://mtest.ctyun.cn:21443";
            var fe = {
                router: y["a"],
                bdReport: !1,
                initHmt: !1,
                ...
                flowReport: {
                    enable: !0,
                    url: "".concat(pe, "/alogic-ctcloudet/v1/portal/pv/Click")
                }
            };
            window.CtcloudAnalysis.install(r["default"], fe)
        }
    ...
    bdd0: function(e, n, t) {
        ...
        function A() {
            var e = window
              , n = navigator;
            return x(["msWriteProfilerMark"in e, "MSStream"in e, "msLaunchUri"in n, "msSaveBlob"in n]) >= 3 && !R()
        }
        function j() {
            var e = window
              , n = navigator;
            ...
            function() {
                return d(e, void 0, void 0, (function() {
                    ...
                    return s(this, (function(n) {
                        switch (n.label) {
                        case 0:
                            return X(e = Q()) ? U ? [2, l(U)] : T() ? [4, (t = document,
    ...
    dd8e: function(e, n, t) {
        ...
        t("2b0e"))
          ...
          , O = {
            ...
            children: [{
                ...
                component: function() {
                    return Promise.all([t.e("chunk-7722201c"), t.e("20201218~add~addBankCard~agent~agentInfo~apply~bindDisk~bindIp~cdn~cloud~cloudCampus~cloudInstance~c~a6cd0e2c"), t.e("agentBank~agentInfo~agentPhone"), t.e("agentBank~agentInfo"), t.e("agentInfo")]).then(t.bind(null, "9b26"))
                }
            }, {
                path: "phone",
                name: "phone",
                ...
                component: function() {
                    return Promise.all([t.e("chunk-7722201c"), t.e("agentBank~agentInfo~agentPhone"), t.e("agentBank~agentInfo"), t.e("agentBank")]).then(t.bind(null, "4f6b"))
                }
            }, {
                path: "submit",
                name: "submit",
        ...
        var He = {}
          , qe = [Re, l, f, m, b, k, y, S, P, A, B, E, d, M, F, q, N, $, V, J, Q, K, ee, ae, ce, ue, se, pe, he, ge, ve, we, Ie, Ce, Pe, Se, Ae, Be]
          , Ue = window.location
          , Ne = Ue.pathname
          , We = Ue.href;
        ...
        var Ve = new i["a"]({
            ...
            routes: [{
                ...
                name: "redirect",
                redirect: function(e) {
                    var n, t = e.query, o = t._method, c = t._params, i = Object(a["a"])(t, Te), u = c ? JSON.parse(c) : {};
                    return n = {},
