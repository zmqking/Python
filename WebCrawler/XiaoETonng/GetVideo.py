...
class M3u8:
    url = 'https://btt-vod.xiaoeknow.com/522ff1e0vodcq1252524126/20c695e95576678021018172864/playlist_eof.m3u8?sign=63babc65b60faee458420f68dc035714&t=6502661d&us=LqbLBKHsSm'
    headers = {
    ...
    def getText(self):
        ...
        with open(f'D:\BaiduNetdiskDownload\test.m3u8','wb')as f:
