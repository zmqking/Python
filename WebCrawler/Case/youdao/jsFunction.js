...
var h = {
    ...
    u: function (t, e) {
        ...
        return h.TYPED_ARRAY_SUPPORT ? (t = new Uint8Array(e),
            t.__proto__ = h.prototype) : (null === t && (t = new h(e)),
            t.length = e),
            t
    },
    fill: function (t, e, n, r) {
        ...
        "number" === typeof t)
            ...
            var s = h.isBuffer(t) ? t : Y(new h(t, r).toString())
                , a = s.length;
            for (o = 0; o < n - e; ++o)
                this[o + e] = s[o % a]
        }
...
//<editor-fold desc="算法">
function g(e) {
    return cypt.createHash("md5").update(e).digest()
}
...
var decodeData = (t, o, n) => {
    if (!t)
        return null;
    const a = h.alloc(16, g(o))
        , c = h.alloc(16, g(n))
        , r = cypt.createDecipheriv("aes-128-cbc", a, c);
